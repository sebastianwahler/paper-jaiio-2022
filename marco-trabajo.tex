...
La idea central es reflejar de manera gráfica, mediante un Grafo, los grupos de pertenencia. Se le llamará nodo a cada círculo, y representa a una persona (con rol de imputado, sospechoso o denunciado) involucrada en dos o más casos penales (existe un gran cúmulo de personas en el sistema con sólo un caso con rol de denunciado, por esa razón se los quita del universo a analizar). El tamaño del nodo posee una relación directa con la cantidad de casos penales en los que se encuentre involucrada la persona. Cuanto mayor sea el tamaño del nodo en más cantidad de casos penales estará involucrado.
